...
<h3 class="header--3">${limitTitle(recipe.title)}<span><i class="fas fa-utensils"></i></span></h3>
...
<i class="detail__time__icon far fa-clock"></i>
 ...
 <span class="detail__time__span__new">Mon:</span>${recipe.hours} ${recipe.hours < '12:00' ? 'am' : 'pm'} - ${recipe.end} pm	
 <span class="detail__time__span__new">Tue:</span>${recipe.hours} ${recipe.hours < '12:00' ? 'am' : 'pm'} - ${recipe.end} pm	
  <span class="detail__time__span__new">Wed:</span>${recipe.tuesday} ${recipe.tuesday < '12:00' ? 'am' : 'pm'} - ${recipe.tuesdayend} pm	
  <span class="detail__time__span__new">Thu:</span>${recipe.tuesday} ${recipe.tuesday < '12:00' ? 'am' : 'pm'} - ${recipe.tuesdayend} pm	
 <span class="detail__time__span__new">Fri:</span>${recipe.tuesday} ${recipe.tuesday < '12:00' ? 'am' : 'pm'} - ${recipe.tuesdayend} pm	
   <span class="detail__time__span__new">Sat:</span>${recipe.hours} ${recipe.hours < '12:00' ? 'am' : 'pm'} - ${recipe.end} pm	
 <span class="detail__time__span__new">Sun:</span>${recipe.sunday} ${recipe.sunday < '12:00' ? 'am' : 'pm'} - ${recipe.sundayend} pm</span>
                    </div>
    </div>
...
<div class="detail__menu">
    ...
    <div class="detail__menu__clock">
        ...
        <div class="detail__menu__clock__details">
            ...
            <span>${recipe.hours} ${recipe.hours < '12:00' ? 'am' : 'pm'} - ${recipe.end} pm</span>
        </div>
    </div>
...
export const people = peep => {
    document.querySelector('.detail__reservation__number').textContent = peep.people;
}
...
export const updateTime = time => {
    document.querySelector('.detail__reservation__hours__select').textContent = time.hours;
}
