...
export default class Recipe {
  ...
  async getRecipe() {
    const bearer =
      "Bearer " +
      "GIDbaihzLPYj898sa3slEi15RURCxE-9C-pBT43L0lKTAd7zij0UCD6RM7U0yvvL1htFi2TUBwbF71ggGu_QUxOTqcfq2p7c4DBB4iIekxkrxoJk1TrPa-qi4EG4XHYx";
    const proxy = "https://cors-anywhere.herokuapp.com/";
    try {
      const rec = await Axios(
        `${proxy}https://api.yelp.com/v3/businesses/${this.id}`,
        {
          method: "GET",
      ...
      const tuesdayyyy =
        tuesdayyy[0] + tuesdayyy[1] + ":" + tuesdayyy[2] + tuesdayyy[3];
      ...
      const sundayenddd =
        sundayendd[0] + sundayendd[1] + ":" + sundayendd[2] + sundayendd[3];
